...
public class MainCitymap extends Activity {
	...
	ArrayList<String> m_citys = new ArrayList<String>();
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
			...
			InputStream txtFile = am.open("citys.txt");
        ...
        m_googleMap.setOnCameraChangeListener(new OnCameraChangeListener() {
            public void onCameraChange(CameraPosition a_cameraPos) {  
	    		...
	    		for(int i=0;i<m_citys.size();i++){
	    			String[] m_rows = DoSplite(m_citys.get(i));
					String m_latitude = m_rows[0];
					String m_longitude = m_rows[1]; 
					String m_cityName = m_rows[2];
					...
					if(m_isCitySet == false || m_nearestCity > m_result){
						if(m_result < 10){
							...
							m_toastDistance.setText(m_stringResult+"km "+"to "+ m_cityName);
						}
						m_nearestCity = m_result;
						m_isCitySet = true;
					}
	    		}
	    		m_toastDistance.setDuration(10);
